...
void kinematicArray2Struct(double *kna, KINEMATICPARAMS5A);
void kinematicArray2Struct(double *kna, KINEMATICPARAMS6A);
void kinematicArray2Struct(double *kna, KINEMATICPARAMS11A);
