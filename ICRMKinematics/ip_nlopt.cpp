...
void IPnlopt_qp0_xyz5A::fun_qp0_xyz5A(int nSamps, double *stackedQ, double *stackedX, double *qp0, double *fmin) {
	FIPDATA fip;
...
void IPnlopt_qp0_xyzuxuyuz5A::fun_qp0_xyzuxuyuz5A(int nSamps, double *stackedQ, double *stackedX, double *stackedU, double *qp0, double *fmin) {
	FIPDATA fip;
	fip.nSamps = (const int)nSamps;
	fip.stackedQ = stackedQ;
	fip.stackedX = stackedX;
...
void IPnlopt_kn0_xyz5A::fun_kn0_xyz5A(int nSamps, double *stackedQ, double *stackedX, double *kn0, double *fmin) {
	FIPDATA fip;
	fip.nSamps = (const int)nSamps;
	fip.stackedQ = stackedQ;
	fip.stackedX = stackedX;
...
double err_kn0_xyz11A(const std::vector<double> &x, std::vector<double> &grad, void *fipData) {
	FIPDATA *pfip;
	pfip = (FIPDATA*)fipData;
	...
	//new kinematic params x = [tx01,ty01,tz01,ry01,rz01,ry34,rz34,kAlpha,eAlpha,lcath,ry45]
...
IPnlopt_kn0_xyz11A::IPnlopt_kn0_xyz11A() {
...
IPnlopt_kn0_xyz11A::IPnlopt_kn0_xyz11A(KINEMATICPARAMS11A knup, KINEMATICPARAMS11A kndn, NLOPTPARAMS nl) {
	kup = knup;
	kdn = kndn;
	nlParams = nl;
}
void IPnlopt_kn0_xyz11A::fun_kn0_xyz11A(int nSamps, double *stackedQ, double *stackedX, double *kn0, double *fmin) {
	FIPDATA fip;
	fip.nSamps = (const int)nSamps;
	fip.stackedQ = stackedQ;
	fip.stackedX = stackedX;

	std::vector<double> x(11), g(11);
	for (int i = 0; i < 11; i++) { x[i] = kn0[i]; }

	*fmin = err_kn0_xyz11A(x, g, &fip);
}
int IPnlopt_kn0_xyz11A::estimate(int nSamps, double *stackedQ, double *stackedX, double *kn0, double *fmin) {
	FIPDATA fip;
	fip.nSamps = (const int)nSamps;
	fip.stackedQ = stackedQ;
	fip.stackedX = stackedX;

	nlopt::opt alg(ipTranslateNLOptAlg(nlParams.method), 11); //there are 11 kinematic params
	...
	std::vector<double> limup(11);
	std::vector<double> limdn(11);
	limup[0] = kup.tx01;
	limup[1] = kup.ty01;
	limup[2] = kup.tz01;
	limup[3] = kup.ry01;
	...
	if (ipTranslateNLOptAlg(nlParams.method) == GN_MLSL || ipTranslateNLOptAlg(nlParams.method) == GN_MLSL_LDS) {
		...
		lAlg.set_min_objective(err_kn0_xyz11A, pfip);
		lAlg.set_upper_bounds(limup);
		lAlg.set_lower_bounds(limdn);
		lAlg.set_stopval(nlParams.minFunVal);
		lAlg.set_ftol_abs(nlParams.tolFunAbs);
		lAlg.set_xtol_abs(nlParams.tolXAbs);
		lAlg.set_maxeval(nlParams.maxIts);
		lAlg.set_maxtime(1.0);//lAlg.set_maxtime(nlParams.maxTimeSec);
...
double err_kn0_xyzuxuyuz11A(const std::vector<double> &x, std::vector<double> &grad, void *fipData) {
	FIPDATA *pfip;
	pfip = (FIPDATA*)fipData;
...
IPnlopt_kn0_xyzuxuyuz11A::IPnlopt_kn0_xyzuxuyuz11A() {
	KINEMATICPARAMS11A k;
	kup = k;
	kdn = k;
	NLOPTPARAMS n;
...
IPnlopt_kn0_xyzuxuyuz11A::IPnlopt_kn0_xyzuxuyuz11A(KINEMATICPARAMS11A knup, KINEMATICPARAMS11A kndn, NLOPTPARAMS nl) {
	kup = knup;
	kdn = kndn;
	nlParams = nl;
}
void IPnlopt_kn0_xyzuxuyuz11A::fun_kn0_xyzuxuyuz11A(int nSamps, double *stackedQ, double *stackedX, double *stackedU, double *kn0, double *fmin) {
	FIPDATA fip;
	fip.nSamps = (const int)nSamps;
	fip.stackedQ = stackedQ;
	fip.stackedX = stackedX;
	...
	*fmin = err_kn0_xyzuxuyuz11A(x, g, &fip);
}
int IPnlopt_kn0_xyzuxuyuz11A::estimate(int nSamps, double *stackedQ, double *stackedX, double *stackedU, double *kn0, double *fmin) {
	FIPDATA fip;
	fip.nSamps = (const int)nSamps;
	fip.stackedQ = stackedQ;
	fip.stackedX = stackedX;
	...
	if (ipTranslateNLOptAlg(nlParams.method) == GN_MLSL || ipTranslateNLOptAlg(nlParams.method) == GN_MLSL_LDS) {
		...
		lAlg.set_min_objective(err_kn0_xyzuxuyuz11A, pfip);
		lAlg.set_upper_bounds(limup);
		lAlg.set_lower_bounds(limdn);
		lAlg.set_stopval(nlParams.minFunVal);
		lAlg.set_ftol_abs(nlParams.tolFunAbs);
...
void IPnlopt_qp0kn0_xyz5A::fun_qp0kn0_xyz5A(int nSamps, double *stackedQ, double *stackedX, double *kn0, double *qp0, double *fmin) {
	FIPDATA fip;
	fip.nSamps = (const int)nSamps;
	fip.stackedQ = stackedQ;
	fip.stackedX = stackedX;
...
double funUX11A(const std::vector<double> &x, std::vector<double> &grad, void *fipData) {
	...
	//tx01,ty01,tz01,ry01,rz01,ry34,rz34,kal,eal,lcath,ry45
...
void InvPNLOpt_xyzdotu11A::fun_xyzdotu11A(int nSamps, double *stackedQ, double *stackedU, double *stackedX, double *kn0, double *qp0, double *fmin) {
	FIPDATA fip;
	fip.nSamps = (const int)nSamps;
	fip.stackedQ = stackedQ;
	fip.stackedU = stackedU;
...
int InvPNLOpt_xyzdotu11A::estimate(int nSamps, double *stackedQ, double *stackedX, double *stackedU, double *kn0, double *qp0, double *fmin) {
	...
	if (ipTranslateNLOptAlg(nlParams.method) == GN_MLSL || ipTranslateNLOptAlg(nlParams.method) == GN_MLSL_LDS) {
		...
		lAlg.set_min_objective(funUX11A, pfip);
		lAlg.set_upper_bounds(limup);
		lAlg.set_lower_bounds(limdn);
		lAlg.set_stopval(nlParams.minFunVal);
		lAlg.set_ftol_abs(nlParams.tolFunAbs);
...
double funxyzpp11A(const std::vector<double> &x, std::vector<double> &grad, void *fipData) {
	FIPDATA *pfip;
	pfip = (FIPDATA*)fipData;
...
void InvPNLOpt_xyzpp11A::fun_xyzpp11A(int nSamps, double *stackedQ, double *stackedU, double *stackedX, double *kn0, double *qp0, double *fmin) {
	FIPDATA fip;
	fip.nSamps = (const int)nSamps;
	fip.stackedQ = stackedQ;
	fip.stackedU = stackedU;
...
void InvPNLOpt_xyzuxuyuz5A::fun_xyzuxuyuz5A(int nSamps, double *stackedQ, double *stackedU, double *stackedX, double *kn0, double *qp0, double *fmin) {
	FIPDATA fip;
	fip.nSamps = (const int)nSamps;
	fip.stackedQ = stackedQ;
	fip.stackedU = stackedU;
...
void InvPNLOpt_xyzuxuyuz11A::fun_xyzuxuyuz11A(int nSamps, double *stackedQ, double *stackedU, double *stackedX, double *kn0, double *qp0, double *fmin) {
	FIPDATA fip;
	fip.nSamps = (const int)nSamps;
	fip.stackedQ = stackedQ;
	fip.stackedU = stackedU;
