...
Eigen::Matrix4d FwdK11A::qps2H04(double *qps) {
	...
	R = Eigen::AngleAxisd(kinParams.ry34, Eigen::Vector3d::UnitY()) * Eigen::AngleAxisd(kinParams.rz34, Eigen::Vector3d::UnitZ())
      * Eigen::AngleAxisd(qps[3], Eigen::Vector3d::UnitZ());
	Rxyz.setIdentity();
	Rxyz(0, 3) = tx;
	Rxyz(1, 3) = ty;
	Rxyz.block<3, 3>(0, 0) = R;

	return FwdK11A::qps2H03(qps) * Rxyz;
}
Eigen::Matrix4d FwdK11A::qps2H05(double *qps) {
	...
	R = Eigen::AngleAxisd(kinParams.ry45, Eigen::Vector3d::UnitY()) * Eigen::AngleAxisd(kinParams.rz45, Eigen::Vector3d::UnitZ());
